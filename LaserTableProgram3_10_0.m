...
% open DK240 monochromator serial communication
% ---------------------------------------------
DK240 = serial('COM3');
...
% make Actual Wavelength box uneditable - this seems to throw lab users off
% -------------------------------------------------------------------------
set(handles.actual_wavelength_edit, 'enable', 'off');
...
% creates signal average function after setting properties
% ========================================================
...
% creates groups of shots function after setting properties
% =========================================================
...
% get the decay time between groups of shots from user
% ====================================================
...
% creates decay time function after setting properties
% ====================================================
...
% creates timebase function after setting properties
% ==================================================
...
% there are issues here that DSW (or another dev) will need to address
% if the Warren lab decides to do long timescale experiments
if SCOPE_TIMEBASE > 7
...
% stop a run once the current nShots number is reached (this has been
% changed?) this is mainly for aborting a failed experiment that would 
% otherwise take a long time to terminate
% ====================================================================
...
% MENU BAR ITEMS: menu -> file
% ============================
function file_Callback(~, ~, ~)


% MENU BAR ITEMS: menu -> file -> save
% ====================================
...
% MENU BAR ITEMS: menu -> instructions
% ====================================
function instructions_Callback(~, ~, ~)


% MENU BAR ITEMS: menu -> instructions -> general instructions
% ============================================================
...
% MENU BAR ITEMS: menu -> instructions -> additional features
% ===========================================================
...
% change DK240 monochromator wavelength
% =====================================
...
% creates wavelength update function after setting properties
% ===========================================================
...
% creates edit exit slit function after setting properties
% ========================================================
...
% creates entrance slit width function after setting properties
% =============================================================
...
% QC9514 DDG: set channel A ON or OFF
% ===================================
...
% QC9514 DDG: set channel A width
% ===============================
...
% QC9514 DDG: creates function after setting properties
% =====================================================
...
% QC9514 DDG: set channel A delay
% ===============================
...
% QC9514 DDG: sync channel A to some other channel
% ================================================
...
% QC9514 DDG: set channel B ON or OFF
% ===================================
...
% QC9514 DDG: set channel B width
% ===============================
...
% QC9514 DDG: set channel B delay
% ===============================
...
% QC9514 DDG: sync channel B to some other channel
% ================================================
...
% QC9514 DDG: set channel C ON or OFF
% ===================================
...
% QC9514 DDG: set channel C width
% ===============================
...
% QC9514 DDG: set channel C delay
% ===============================
...
% QC9514 DDG: sync channel C to some other channel
% ================================================
...
% QC9514 DDG: set channel D ON or OFF
% ===================================
...
% QC9514 DDG: set channel D width
% ===============================
...
% QC9514 DDG: set channel D delay
% ===============================
...
% QC9514 DDG: sync channel D to some other channel
% ================================================
...
% QC9514 DDG: creates pulse state checkboxfunction after setting properties
% =========================================================================
...
% execute on button press in pulse_state_checkbox
% ===============================================
...
% set PMT voltage using a slider
% ==============================
...
% creates PMT voltage slider after setting properties
% ===================================================
